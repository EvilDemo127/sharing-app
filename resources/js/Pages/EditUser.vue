            ...
            <div class="row justify-content-center">
                <div class="">
                    ...
                    >
                        <!-- Card Header -->
                        <div
                            class="card-header bg-light border-0 py-3 px-4 border-start border-4 border-primary"
                        >
                            <div class="d-flex align-items-center gap-2">
                                <i
                                    class="fas fa-user-edit text-primary fs-5"
                                ></i>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div
                                class="d-flex flex-column align-items-center mb-4 p-3 bg-light rounded-3 border border-dashed text-center"
                            >
                                <div
                                    class="position-relative avatar-wrapper mb-2"
                                >
                                    <img
                                        :src="
                                            user.image
                                    ...
                                    <label
                                        for="image-upload"
                                        class="position-absolute bottom-0 end-0 bg-primary text-white rounded-circle shadow d-flex align-items-center justify-content-center cursor-pointer"
                                        style="
                                            width: 32px;
                                            height: 32px;
                                            cursor: pointer;
                                ...
                                <span class="text-muted small"
                                    >Click camera icon to change photo</span
                                >
                            </div>
                            ...
                            <!-- Action Button Panel -->
                            <div
                                class="d-flex justify-content-end mt-4 pt-2 border-top border-light"
                            >
                                <button
...
// Local preview of the newly picked photo (shown until the form is
// submitted and the server returns the updated user.image)
